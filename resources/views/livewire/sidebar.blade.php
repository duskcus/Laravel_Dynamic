<div>
    <!-- Sidebar -->
    <div class="p-4 space-y-4 bg-base-200 rounded-box hidden lg:block">
        ...
        <!-- Optional Divider Between Sections (if needed) -->
        {{-- <li class="my-4 divider"></li> --}}

        <!-- Social Media or Extra Links (Optional) -->
        {{-- <div class="grid grid-flow-col gap-4">
            <a href="{{ route('placeholder') }}" class="text-xl">
