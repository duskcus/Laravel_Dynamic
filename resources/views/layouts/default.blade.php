            ...
            @livewire('sidebar', ['sections' => [
                ...
                [
                    ...
                    'links' => [
                        ...
                        ['name' => 'Toast', 'url' => route('toast'), 'icon' => 'fa fa-bell'],
                        ['name' => 'Loader', 'url' => route('loader'), 'icon' => 'fa fa-spinner'],
                        ['name' => 'Pop-up', 'url' => route('popup'), 'icon' => 'fa fa-window-restore'],
                    ],
                ],
                [
                    'title' => 'Security',
                    'links' => [
                        ['name' => 'Stepper', 'url' => route('stepper'), 'icon' => 'fa fa-stairs'],
